...
// Seed real data helper
async function seedRealData(client: pg.PoolClient) {
  // Clear older test records
  ...
  const peopleData = [
    {
      id: "p_rafidain",
      name: "شركة الرافدين للتجارة العامة (بغداد - الشورجة)",
      phone: "+964 770 123 4567",
      notes: "عميل تجاري رئيسي - حساب مشترك بالدينار العراقي والدولار",
    },
    {
      id: "p_erbil",
      name: "عمر فاروق البازركان (أربيل - عنكاوا)",
      phone: "+964 750 987 6543",
      notes: "موزع إقليمي - تعامل بالليرة التركية والدولار",
    },
    {
      id: "p_istanbul",
      name: "شركة النور الدولية للتصدير (إسطنبول - لالالي)",
      phone: "+90 532 456 7890",
      notes: "مورد بضائع وأقمشة - تعامل بالليرة التركية والدولار",
    },
    {
      id: "p_basra",
      name: "حيدر جاسم الكرخي (البصرة - العشار)",
      phone: "+964 780 445 5667",
      notes: "مقاولات ومعدات تبريد - دينار عراقي",
    },
    {
      id: "p_najaf",
      name: "مكتب الصادق للمقاولات والتوريدات (النجف)",
      phone: "+964 771 889 9001",
      notes: "توريد معدات ومواد مكتبية",
    },
  ];

  for (const p of peopleData) {
    await client.query(
      "INSERT INTO people (id, name, phone, notes) VALUES ($1, $2, $3, $4)",
      [p.id, p.name, p.phone, p.notes]
    );
  }

  // 2. Transactions (IQD, USD, TRY)
  const transactionsData = [
    // p_rafidain (IQD & USD)
    {
      id: "t_raf_1",
      person_id: "p_rafidain",
      type: "debt",
      amount: 4500000,
      currency: "IQD",
      description: "بضاعة قرطاسية ومواد مكتبية - فاتورة رقم 140",
      date: pastDays(12),
    ...
    },
    {
      ...
      amount: 2000000,
      currency: "IQD",
      description: "سداد دفعة نقدية عبر صيرفة الرواد في الكفاح",
      date: pastDays(6),
      due_date: null,
      status: "completed",
    },
    {
      ...
      amount: 1400,
      currency: "USD",
      description: "شحن حاوية تجارية من ميناء أم قصر",
      date: pastDays(8),
    ...
    },
    {
      ...
      amount: 600,
      currency: "USD",
      description: "تحويل سداد جزئي دولار",
      date: pastDays(2),
      due_date: null,
      status: "completed",
    },
    ...
    // p_erbil (TRY & USD)
    {
      ...
      amount: 18500,
      currency: "TRY",
      description: "شراء شحنة ألبسة جاهزة - إسطنبول إلى أربيل",
      date: pastDays(15),
      due_date: pastDays(4), // Overdue!
      status: "pending",
    },
    {
      id: "t_erb_2",
      ...
      amount: 12000,
      currency: "TRY",
      description: "حوالة ليرة عبر مكتب أربيل للصرافة",
      date: pastDays(5),
      due_date: null,
      status: "completed",
    },
    {
      ...
      amount: 2200,
      currency: "USD",
      description: "أجهزة هواتف ذكية وملحقاتها",
      date: pastDays(20),
    ...
    },
    {
      ...
      amount: 2200,
      currency: "USD",
      description: "سداد كامل قيمة الهواتف نقداً",
      date: pastDays(7),
      due_date: null,
      status: "completed",
    },
    ...
    {
      id: "t_ist_1",
      person_id: "p_istanbul",
      type: "debt",
      amount: 45000,
      currency: "TRY",
      description: "أقمشة ومستلزمات خياطة تركية ماركة إسطنبول",
      date: pastDays(10),
    ...
    },
    {
      ...
      amount: 25000,
      currency: "TRY",
      description: "سداد دفعة أولى عبر حوالة ويسترن يونيون",
      date: pastDays(4),
      due_date: null,
      status: "completed",
    },
    ...
    // p_basra (IQD)
    {
      ...
      amount: 3800000,
      currency: "IQD",
      description: "معدات ومكيفات صيفية لمشروع المعقل",
      date: pastDays(14),
      due_date: pastDays(5), // Overdue!
      status: "pending",
    },
    {
      id: "t_bas_2",
      ...
      amount: 1500000,
      currency: "IQD",
      description: "دفعة سداد عبر محفظة زين كاش",
      date: pastDays(3),
      due_date: null,
      status: "completed",
    },
    ...
    // p_najaf (USD)
    {
      ...
      amount: 3500,
      currency: "USD",
      description: "تجهيز خوادم وشبكات اتصال للمكتب",
      date: pastDays(7),
      due_date: futureDays(14),
      status: "pending",
    },
    {
      id: "t_naj_2",
      ...
      amount: 1500,
      currency: "USD",
      description: "دفعة نقدية بالدولار مستلمة باليد",
      date: pastDays(2),
      due_date: null,
      status: "completed",
    },
  ...
  // 3. Expenses (IQD, USD, TRY)
  const expensesData = [
    {
      id: "exp_1",
      person_name: "عقارات المنصور - بغداد",
      amount: 850000,
      currency: "IQD",
      reason: "إيجار المقر والمخزن التجاري عن الشهر الجاري",
      date: pastDays(5),
      category: "إيجار وفواتير",
    },
    {
      id: "exp_2",
      person_name: "شركة الأنوار الدولية للتجارة",
      amount: 1650,
      currency: "USD",
      reason: "شراء شحنة أدوات كهربائية وإلكترونيات مستوردة",
      date: pastDays(9),
      category: "مشتريات",
    },
    {
      id: "exp_3",
      person_name: "طيران بيغاسوس للشحن الجوي (إسطنبول)",
      amount: 6800,
      currency: "TRY",
      reason: "أجور شحن سريع طرود وبضائع",
      date: pastDays(4),
      category: "شحن ونقل",
    },
    {
      id: "exp_4",
      person_name: "رواتب كادر المبيعات والمخزن",
      amount: 1200000,
      currency: "IQD",
      reason: "رواتب ومكافآت الموظفين",
      date: pastDays(7),
      category: "رواتب ومستحقات",
    },
    {
      id: "exp_5",
      person_name: "خدمات الحوسبة والاتصالات السحابية",
      amount: 140,
      currency: "USD",
      reason: "اشتراك خوادم ونطاق النظام المالي السحابي",
      date: pastDays(1),
      category: "تشغيل",
    },
  ];
  ...
  // 4. Income (IQD, USD, TRY)
  const incomeData = [
    {
      id: "inc_1",
      source_person: "سوق الشورجة المركزي - مبيعات جملة",
      amount: 6200000,
      currency: "IQD",
      reason: "مقبوضات مبيعات جملة نقدية للمتاجر والمحلات",
      date: pastDays(3),
      category: "مبيعات",
    },
    {
      id: "inc_2",
      source_person: "شركة دجلة والفرات للإنشاءات",
      amount: 4500,
      currency: "USD",
      reason: "تحصيل دفعة عقد توريد مستلزمات مشاريع",
      date: pastDays(6),
      category: "تحصيل ديون",
    },
    {
      id: "inc_3",
      source_person: "معرض إسطنبول للأقمشة والتصدير",
      amount: 22000,
      currency: "TRY",
      reason: "أرباح مبيعات وشحنات تصدير خارجية",
      date: pastDays(8),
      category: "أرباح واستثمار",
    },
    {
      id: "inc_4",
      source_person: "مكتب خدمات الصيانة والتوزيع الفوري",
      amount: 1850000,
      currency: "IQD",
      reason: "إيرادات خدمات صيانة وتوزيع دورية",
      date: pastDays(2),
      category: "خدمات",
    },
  ];
  ...
  console.log("Real seed data (IQD, USD, TRY) inserted successfully.");
}
...
async function initDatabase() {
  ...
  try {
    ...
    try {
      ...
      // User requested: "Delete the initial data."
      // Clean slate - remove all transactions, people, expenses, income, backups
      await client.query("DELETE FROM transactions;");
      await client.query("DELETE FROM people;");
      await client.query("DELETE FROM expenses;");
      await client.query("DELETE FROM income;");
      await client.query("DELETE FROM backups;");
      console.log("Initial data cleared successfully as requested by user.");
...
// Seed endpoint to re-populate real sample data on demand
app.post("/api/seed", async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      res.json({ success: true, message: "Real data (IQD, USD, TRY) seeded successfully" });
    } finally {
      client.release();
    }
  } catch (err: any) {
