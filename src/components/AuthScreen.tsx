    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center px-4 py-2.5 rounded-2xl bg-white shadow-xl shadow-emerald-950/40 mb-3 border border-slate-200/20">
            <img
              src="/logo.png"
              alt="OsiFarma"
          ...
          <h1 className="text-xl font-bold text-white tracking-tight">
            {language === 'ar' ? 'نظام OsiFarma المالي' : 'OsiFarma Financial Manager'}
          </h1>
